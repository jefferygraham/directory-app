...
const bookingList = [
  {
    ...
    name: 'Trainer #1',
    address: '1305 5th St NE Washington, DC 20002',
    dateAndTime: '10:00 AM, 20 Dec 2021',
    services: 'In Person Training',
    isDone: false,
  },
];
      ...
      <View style={styles.bookingInfoWrapStyle}>
        ...
        <View style={{ padding: Sizes.fixPadding * 2.0 }}>
          ...
          >
            ...
            <Text style={{ ...Fonts.blackColor14Regular }}>{item.car}</Text>
          </View>
          <View
            style={{
              flexDirection: 'row',
