...
class ServiceProviderScreen extends Component {
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: Colors.whiteColor }}>
        ...
        >
          <View style={{ paddingBottom: Sizes.fixPadding * 8.0 }}>
            ...
            {this.state.currentInfoIndex == 1 ? <>{this.services()}</> : null}
            ...
            {this.state.currentInfoIndex == 3 ? <>{this.reviews()}</> : null}
          </View>
        </CollapsingToolbar>
        {this.state.currentInfoIndex == 1 ? <>{this.bookNowButton()}</> : null}
        <Snackbar
          style={{
            ...styles.snackBarStyle,
            bottom: this.state.currentInfoIndex == 1 ? 40.0 : -10.0,
          }}
    ...
    return (
      <TouchableOpacity
        ...
        style={{
          flex: 1,
          backgroundColor:
            this.state.currentInfoIndex == index
              ? Colors.primaryColor
              : Colors.whiteColor,
          alignItems: 'center',
          justifyContent: 'center',
  ...
  serviceInfo() {
    return (
      ...
      >
        <Text style={{ ...Fonts.blackColor18Bold }}>{this.item.place}</Text>
        <Text
          style={{
