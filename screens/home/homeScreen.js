...
const markers = [
  ...
  },
  {
    ...
    place: 'Trainer #2',
    address: '1201 1st St NE, WDC 20002',
    rating: '4.5',
    distance: '3.5',
    cost: 50,
  },
  {
    ...
    place: 'Trainer #3',
    address: '524 Rhode Island Ave NE, WDC 20002',
    rating: '4.5',
    distance: '3.5',
    cost: 50,
  },
        ...
        {markerList.map((marker, index) => (
          <View key={index}>
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() =>
                props.navigation.push('ServiceProvider', { marker })
              }
            ...
            >
              ...
              >
                <View>
                  <Text style={{ ...Fonts.grayColor12Regular }}>Distance</Text>
                ...
                <View style={styles.bookNowButtonStyle}>
                  <Text style={{ ...Fonts.blackColor12Regular }}>Book now</Text>
                </View>
              </View>
            </TouchableOpacity>
          </View>
